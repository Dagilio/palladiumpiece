...
execute as @s at @s anchored eyes rotated as @s run summon minecraft:armor_stand ~ ~ ~ {Tags:["RAray","RAactiveRay","RAnew","RAentityRay"],Small:1b,Marker:1b,NoGravity:1b,Invisible:1b}
...
execute as @e[tag=RAnew] run function ra:general/entitygeneral
